...
export default function Calculo() {
    return (
        <div>
            ...
            <Calculo1 src="/assets/calculo1.png" alt='Lei da Gravitação Universal' width={187} height={71}/>
            <Calculo2 src="/assets/calculo2.png" alt='Força Gravitacional Hipotética' width={462} height={77}/>
            <p>
